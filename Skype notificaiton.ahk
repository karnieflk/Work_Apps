...
[AHK2EXE]
Exe_File=%In_Dir%\Skype Notification 1.0.exe
[VERSION]
Set_Version_Info=1
...
Added detection if you are presenting and auto disables
got it to work if app is minimized
Discovered if you are in conversation with multiples, added, to the  list ot bring up
*/
...
DetectHiddenWindows on
	global notecheck, config_file, Screen_sharing
	Screen_sharing = 0
Disabled = 0
	...
	Menu, Tray, NoStandard
		...
		Menu, Tray, Add, Disable, DisableApp
...
Gui, Options:Add, CheckBox, x11 y35 w218 h27  Checked%notecheck% vnotecheck gupdateinifile , Bring Skype message window to Front
Gui, Options:Add, CheckBox, x11 y69 w218 h22 Checked%Boarder% vboarder gupdateinifile, Show Monitor(s) Notification Borders
Gui, Options:Add, CheckBox, x11 y150 w236 h27 Checked%Startup% vStartup gStart_with_computer,Startup with computer
...
Gui, Options:Add, Text, x16 y103 w37 h17 , RED
Gui, Options:Add, Text, x16 y130 w41 h21 , GREEN
Gui, Options:Add, Text, x16 y158 w45 h16 , BLUE
Gui, Options:Add, Edit, x59 y100 w48 h18 vRed_value gupdateinifile , %red_value%
Gui, Options:Add, Edit, x59 y127 w48 h18  vGreen_Value gupdateinifile, %Green_value%
Gui, Options:Add, Edit, x59 y156 w48 h18 vBlue_Value gupdateinifile, %Blue_value%
...
Gui, Options:Add, Text, x143 y140 w79 h26   , (In Pixels)
...
Gui, Options:Add, Text, x344 y135 w45 h22  , (0-255)
...
Notify_user(lParam, classcheck)
{
	global notecheck, Boarder
	SetTimer, Find_Skype_notificaiton, off

		WinGetTitle, Title, ahk_id %lParam%
		IF (notecheck)
			Activate("ahk_class " classcheck)
